...
const displayStr = unfundedGamesCount == 1 ? `A total of ${raisedCard.innerText} has been raised for ${GAMES_JSON.length} games. Currently, ${unfundedGamesCount} game remains unfunded. We need your help to fund these amazing games!` : `A total of ${raisedCard.innerText} has been raised for ${GAMES_JSON.length} games. Currently, ${unfundedGamesCount} games remains unfunded. We need your help to fund these amazing games!`
...
var { name, descr, pl, goal, bkrs, img } = GAMES_JSON[0];
console.log(name);
...
var { name, descr, pl, goal, bkrs, img } = GAMES_JSON[1];
console.log(name);
// do the same for the runner up item
const secondGame = document.createElement("p");
secondGame.innerText = name;
